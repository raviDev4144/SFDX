...
def BUILD_NUMBER=env.BUILD_NUMBER
    ...
    withCredentials([file(credentialsId: 'e06cb06c-72a2-44cb-a831-0c52d26c4ea9', variable: 'jwt_key_file')]) {
        ...
        stage('Authorize the Org'){
            ...
            rc1 = command "${toolbelt}/sfdx force:auth:jwt:grant --clientid 3MVG9cHH2bfKACZZV5KqEsTf5X4IrB7hvKrUP9X_ig2OgvUc5bGvaNWPCI48UTONvQHk69_R5J9aF9Hq3ZgpX --jwtkeyfile ${jwt_key_file} --username naga@naga.devtest --instanceurl https://login.salesforce.com
            if(rc1 != 0){
